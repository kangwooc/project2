...
public class ChainedHashDictionary<K, V> implements IDictionary<K, V> {
    ...
    private IDictionary<K, V>[] doubleArrayCapacity() {
        IDictionary<K, V>[] result = makeArrayOfChains(2 * chains.length);
     ...
     *
     * 2. Think about what exactly your *invariants* are. Once you've decided, write
     * them down in a comment somewhere to help you remember.
     *
     * 3. Before you try and write code, try designing an algorithm using pencil and
     ...
     *
     * 4. Think about what exactly your *invariants* are. As a reminder, an
